...
<div class="d-flex justify-content-between align-items-center flex-wrap">
    ...
    <div onclick="addRespond(this,{{$pos}})" id="div-{{$pos}}-{{$counter}}" data-respond="{{$counter}}" class="d-flex justify-content-between align-items-center col-12 col-md-5 col-lg-3 mt-2 responsive-div show-all" style="cursor: pointer;">
